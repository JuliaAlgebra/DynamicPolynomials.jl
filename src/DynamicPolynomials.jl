...
MP.similar_variable(p::Type{<:PolyType{C}}, ::Type{Val{V}}) where {C, V} = PolyVar{C}(string(V))
MP.similar_variable(p::Type{<:PolyType{C}}, V::Symbol) where {C} = PolyVar{C}(string(V))
MP.similar_variable(p::PolyVar{C}, ::Type{Val{V}}) where {C,V} = PolyVar{C}(string(V), p.kind)
MP.similar_variable(p::PolyVar{C}, V::Symbol) where {C} = similarvariable(p, Val{V})
